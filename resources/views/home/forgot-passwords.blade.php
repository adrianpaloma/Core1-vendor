...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header text-center"><a href="/"><img class="logo-img" src="home/assets/images/logo.png" alt="logo" style="width: 200px; margin-left: auto; margin-right: auto; display: block" ></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
                <form>
